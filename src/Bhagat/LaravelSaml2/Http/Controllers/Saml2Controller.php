...
namespace Bhagat\LaravelSaml2\Http\Controllers;

use Bhagat\LaravelSaml2\Events\Saml2LoginEvent;
...
class Saml2Controller extends Controller
{
    ...
    public function acs(Saml2Auth $saml2Auth, $idpName)
    {
        ...
        if ($redirectUrl !== null) {
            return redirect($redirectUrl.'?e='. $email);
        } else {
            return redirect(config('saml2_settings.loginRoute').'?e='. $email);
        }
    }
